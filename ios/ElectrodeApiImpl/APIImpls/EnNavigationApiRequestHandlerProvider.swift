 ...
 */
@objc public class EnNavigationApiRequestHandlerProvider : RequestHandlerProvider, EnNavigationApiRequestHandlerDelegate
{
    /**
     * - Parameter config : Optional config object that can be passed to an api impl provider.
     */
    init(handlerConfig: EnNavigationApiConfig? = nil)
    {
        super.init(config: handlerConfig)
    }

    public func registerNavigateRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
    public func registerUpdateRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
    public func registerFinishRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
    public func registerBackRequestHandler()
    {
        // TODO: Needs to be implemented.
    }
...
public class EnNavigationApiConfig : RequestHandlerConfig
{
